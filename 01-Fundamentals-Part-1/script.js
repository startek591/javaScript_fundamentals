...
// birthYear = 1990; - const variable can't be reassigned again with another value.
// const job; - const variable must be initialized with a value
...
// Operator Precedence
const presentTime = 2037;
const ageJonas1 = presentTime - 1991;
const ageSarah1 = presentTime - 2018;
...
console.log(ageJonas1, ageSarah, averageAge);
...
if (BMIMark2 > BMIJohn2) {
  ...
  console.log(
    `John's BMI (${BMIJohn2} is higher than Mark's (${BMIMark2})`
  );
}
...
if (hasDriversLicense && hasGoodVision) {
  ...
  console.log('Somehone else should drive...');
}
...
console.log(scoreDolphins, scoreKoalas2);
...
age2 >= 18
  ...
  : console.log('I lik to drink water 💧');
